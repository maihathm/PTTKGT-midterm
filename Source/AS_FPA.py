...
def AS_FPA(MaxIteration,MaxFlower,MinValue,MaxValue,initial,distance_matrix, BKS=7542):
    ...
    fpa_position = FPA.init_population(N=MaxFlower, min_val=min_values, max_val=max_values, function=ACO.ant_colony_optimization, initial=initial, distance_matrix=distance_matrix)
